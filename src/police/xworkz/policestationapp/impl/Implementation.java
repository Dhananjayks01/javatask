package police.xworkz.policestationapp.impl;
...
public class Implementation implements PoliceStation {
    Officers[] officers ;
    int index = 0;

    public void PoliceStation(int size){
    ...
    @Override
    public void newOfficersAfterDeleted(Officers[] officers) {
